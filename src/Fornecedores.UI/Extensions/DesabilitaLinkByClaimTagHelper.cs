...
{
    [HtmlTargetElement("a", Attributes = "disable-by-clain-name")]
    [HtmlTargetElement("a", Attributes = "disable-by-clain-value")]
    public class DesabilitaLinkByClaimTagHelper : TagHelper
    {
        ...
        [HtmlAttributeName("disable-by-clain-name")]
        public string IdentityClaimName { get; set; }

        [HtmlAttributeName("disable-by-clain-value")]
